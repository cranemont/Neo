...
export const click: Tool = {
  ...
  handle: async (context, params) => {
    ...
    return runAndWait(
      ...
      () => context.refLocator(validatedParams.ref).click(),
      true,
    );
  },
};
...
export const hover: Tool = {
  ...
  handle: async (context, params) => {
    ...
    return runAndWait(
      ...
      () => context.refLocator(validatedParams.ref).hover(),
      true,
    );
  },
};
...
export const selectOption: Tool = {
  ...
  handle: async (context, params) => {
    ...
    return await runAndWait(
      context,
      `Selected option in "${validatedParams.element}"`,
      async () => {
        const locator = context.refLocator(validatedParams.ref);
...
export const screenshot: Tool = {
  ...
  handle: async (context, params) => {
    ...
    const options: playwright.PageScreenshotOptions = validatedParams.raw
      ? { type: 'png', scale: 'css' }
      ...
      content: [
        {
          ...
          mimeType: validatedParams.raw ? 'image/png' : 'image/jpeg',
        },
      ],
    };
  },
